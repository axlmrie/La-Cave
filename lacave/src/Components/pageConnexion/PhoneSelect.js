...
const countries = [
    ...
    { code: 'VA', name: 'Vatican', dial_code: '+39' },
...
const formatOptionLabel = ({ value, label, countryCode }) => (
  <div  id="value" style={{ display: 'flex', alignItems: 'center' }}>
    <CountryFlag countryCode={countryCode} svg style={{ marginRight: 10, width: '20px', height: '15px' }} />
    {label}
  </div>
);
...
const PhoneSelect = () => {
  ...
  return (
    <div style={{ display: 'flex',flexDirection:'row',gridTemplate: '1fr 3fr'}}>
      <Select
        options={options}
        formatOptionLabel={formatOptionLabel}
        placeholder="Selectionner indicatif..."
        isClearable={true}
        isSearchable={true}
